...
import com.junseongday.restapispring.accounts.AccountAdapter;
import com.junseongday.restapispring.accounts.CurrentUser;
import com.junseongday.restapispring.common.ErrorsResource;
...
public class EventController {
    ...
    public ResponseEntity createEvent(@RequestBody @Valid EventDto eventDto,
        ...
        eventValidator.vailidate(eventDto, errors);
        if (errors.hasErrors()) {
            return badRequest(errors);
        }
    ...
    public ResponseEntity updateEvent(@PathVariable Integer id,
        ...
        this.eventValidator.vailidate(eventDto, errors);
        if (errors.hasErrors()) {
            return badRequest(errors);
        }
